...
typedef enum
{
	...
	SHOW_GUNA_ERR,			    //A枪故障
	SHOW_GUNB_ERR,			     //B枪故障
	SHOW_GUNA_WARNING,		//A枪告警
	SHOW_GUNB_WARNING,		//B枪告警
	SHOW_GUN_NOTE,			 //无故障
	SHOW_HAND_EXIT,			 //手动模式退出提示
	SHOW_DIV_ERR,			    //设备信息中显示故障
	SHOW_DIV_WARNING,		//设备信息中显示告警
	SHOW_DIV_NORMAL,		//设备信息中显示正常
	SHOW_GUN_HOMING,		//枪归位
	SHOW_GUN_UNHOMING,	//枪未归位�?
	SHOW_STATE_CONNECT,		//连接
	SHOW_STATE_UNCONNECT,	//未连接
	...
	SHOW_ENDFAIL_RECVCCUTIMEOUT,	//接收CCU帧超时
	SHOW_NULL,				                      //清空显示显示
//停止完成帧原�?
   SHOW_STOP_ERR_NONE,
   SHOW_STOP_TCUNORMAL,             
   ...
   SHOW_STOP_DOORERR,   
	SHOW_STOP_XQERR,                        //倾斜
	SHOW_STOP_SJERR,                        //水芹
	SHOW_SHOW_STOP_SWAERR,        //ֱ直流接触器A
	SHOW_STOP_SWBERR,                   //ֱ直流接触器B
	SHOW_STOP_QJERR,                    //桥架  
   ...
   SHOW_STOP_BSMINSOLUTION ,                 
	...
	SHOW_STOP_BSTINSULATIONERR,		 //绝缘故障
	SHOW_STOP_BSTSWOVERT,				 //输出连接器过温故障
	SHOW_STOP_BSTELOVERT,				//BMS元件过温故障
	SHOW_STOP_CERR,     				      //输出连接器故障
	SHOW_STOP_BSTBATOVERT,        //电池组过温故障
	SHOW_STOP_BSTHIGHRLCERR,   //高压继电器故障
	SHOW_STOP_BSTTPTWO,          //检测点2电压检测故障
	SHOW_STOP_BSTOTHERERR,    //BST其它故障
	SHOW_STOP_BALANCE,
	SHOW_STOP_SOC,

	SHOW_CARD_LOCK,		     //卡位结算
	SHOW_CARD_UNLOCK,	//卡已经结算
	...
	SHOW_MODULE_TH_40KW,
	SHOW_MODULE_YL_30KW,
	SHOW_MODULE_YL_20KW_1000V,  //永联20KW-1000V
