...
__packed typedef struct 
{
	...
	INT8U NetState;			//网络状态  	 0  单机 	1网络---又分4g或者以太网模式
	...
	INT8U Net4GorEternet;	//网络模式下--分为4g或者是以太网
	INT8U gateway[4];       //设置的网关：  例如:192.168.1.1
	INT8U DHCPip[4];        //设置的IP地址：例如:192.168.1.22
	INT8U DHCPZWIP[4];      //设置子网掩码：255.255.255.0
