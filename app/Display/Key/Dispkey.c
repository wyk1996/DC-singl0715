...
{	
	...
	switch(*keyval)
    {
		...
		case LCD_KEY3:		//下一页
			DisplayCommonMenu(&HYMenu85,NULL);
			break;
	 ...
	 //28-新电途
	  case LCD_KEY28:
			SYSSet.NetNum = 1;
			SYSSet.NetYXSelct = XY_XDT;  //当前新电途
			memcpy(SYSSet.IP,NetConfigInfo[SYSSet.NetYXSelct].IP,sizeof(SYSSet.IP));
			SYSSet.Port = NetConfigInfo[SYSSet.NetYXSelct].port;
			memset(NetConfigInfo[SYSSet.NetYXSelct].pIp,0,sizeof(NetConfigInfo[SYSSet.NetYXSelct].pIp));
			snprintf(NetConfigInfo[SYSSet.NetYXSelct].pIp,sizeof(NetConfigInfo[SYSSet.NetYXSelct].pIp),"%d.%d.%d.%d",SYSSet.IP[0],SYSSet.IP[1],SYSSet.IP[2],SYSSet.IP[3]);
	  ...
	  case LCD_KEY29:
			SYSSet.NetNum = 1;
			SYSSet.NetYXSelct = XY_GZZJ;  //贵州中交
			memcpy(SYSSet.IP,NetConfigInfo[SYSSet.NetYXSelct].IP,sizeof(SYSSet.IP));
			SYSSet.Port = NetConfigInfo[SYSSet.NetYXSelct].port;
			memset(NetConfigInfo[SYSSet.NetYXSelct].pIp,0,sizeof(NetConfigInfo[SYSSet.NetYXSelct].pIp));
			snprintf(NetConfigInfo[SYSSet.NetYXSelct].pIp,sizeof(NetConfigInfo[SYSSet.NetYXSelct].pIp),"%d.%d.%d.%d",SYSSet.IP[0],SYSSet.IP[1],SYSSet.IP[2],SYSSet.IP[3]);
	...
	switch(*keyval)
    {
		 ...
		 case LCD_KEY4:		//Vin启动,临时在这里直接发
			 	if(SYSSet.NetState == DISP_NET)
				{
					...
					if((SYSSet.NetYXSelct == XY_ZSH)||(SYSSet.NetYXSelct == XY_XDT)||(SYSSet.NetYXSelct == XY_TTC)||(SYSSet.NetYXSelct == XY_AP)||(SYSSet.NetYXSelct == XY_HY)||(SYSSet.NetYXSelct == XY_YL2)||(SYSSet.NetYXSelct == XY_YD)||(SYSSet.NetYXSelct == XY_GZZJ)||(SYSSet.NetYXSelct == XY_JG)||(SYSSet.NetYXSelct == XY_YKC)||(SYSSet.NetYXSelct == XY_TT)||(SYSSet.NetYXSelct == XY_YL3)||(SYSSet.NetYXSelct == XY_YL4)||(SYSSet.NetYXSelct == XY_XJ)||(SYSSet.NetYXSelct == XY_YL1)) 
					{
		...
		case LCD_KEY5:		//Vin启动,临时在这里直接发
			 	if(SYSSet.NetState == DISP_NET)
				{
					...
					if((SYSSet.NetYXSelct == XY_ZSH)||(SYSSet.NetYXSelct == XY_XDT)||(SYSSet.NetYXSelct == XY_TTC)||(SYSSet.NetYXSelct == XY_AP)||(SYSSet.NetYXSelct == XY_HY)||(SYSSet.NetYXSelct == XY_YKC)||(SYSSet.NetYXSelct == XY_TT)||(SYSSet.NetYXSelct == XY_YL3)||(SYSSet.NetYXSelct == XY_YL4))
					{
						Net_StartCharge(pdisp_conrtol->CurUserGun,MODE_VIN);
						Set_VIN_Success(pdisp_conrtol->CurUserGun,VIN_IDLE);
						DisplayCommonMenu(HYMenu22.Menu_PrePage,NULL);
...
void HYKeyEvent57(_LCD_KEYVALUE *keyval)
{
	...
	switch(*keyval)
	{
		...
		case LCD_KEY4:			//单机
			...
			break;
		case LCD_KEY5:			
			SYSSet.NetState = DISP_NET;  //网络版本下 
		    SYSSet.Net4GorEternet = NET_4G;   //4g网络
		...
		case LCD_KEY27:			//以太网
		    ...
		    SYSSet.Net4GorEternet = NET_Ethernet;   //以太网版本
...
void HYKeyEvent81(_LCD_KEYVALUE *keyval)
{
    ...
    switch(*keyval)
    {
		case LCD_KEY4: //A枪按键
			keynum = 0;
			keynum1 = 0;
			if((SYSSet.NetYXSelct == XY_ZSH)||(SYSSet.NetYXSelct == XY_XDT)||(SYSSet.NetYXSelct == XY_TTC)||(SYSSet.NetYXSelct == XY_AP)||(SYSSet.NetYXSelct == XY_HY)||(SYSSet.NetYXSelct == XY_TT)||(SYSSet.NetYXSelct == XY_TT)||(SYSSet.NetYXSelct == XY_JG)||(SYSSet.NetYXSelct == XY_YL2)||(SYSSet.NetYXSelct == XY_YD)||(SYSSet.NetYXSelct == XY_GZZJ)||(SYSSet.NetYXSelct == XY_YKC)||(SYSSet.NetYXSelct == XY_YL3)||(SYSSet.NetYXSelct == XY_YL4)||(SYSSet.NetYXSelct == XY_XJ)||(SYSSet.NetYXSelct == XY_YL1)) 
			{
			//枪连接而且空闲
				if((pdisp_conrtol->NetGunState[GUN_A] == GUN_IDLE )&& (GetGunState(GUN_A) == GUN_CONNECTED)) 
				{
        ...
        case LCD_KEY5: //B枪按键
			keynum = 0;
			keynum1 = 0;
			if((SYSSet.NetYXSelct == XY_ZSH)||(SYSSet.NetYXSelct == XY_XDT)||(SYSSet.NetYXSelct == XY_TTC)||(SYSSet.NetYXSelct == XY_AP)||(SYSSet.NetYXSelct == XY_HY)||(SYSSet.NetYXSelct == XY_JG)||(SYSSet.NetYXSelct == XY_TT)||(SYSSet.NetYXSelct == XY_YL2)||(SYSSet.NetYXSelct == XY_YD)||(SYSSet.NetYXSelct == XY_GZZJ)||(SYSSet.NetYXSelct == XY_YKC)||(SYSSet.NetYXSelct == XY_YL3)||(SYSSet.NetYXSelct == XY_YL4)||(SYSSet.NetYXSelct == XY_XJ)||(SYSSet.NetYXSelct == XY_YL1)) 
			{
				//枪连接而且空闲
				if((pdisp_conrtol->NetGunState[GUN_B] == GUN_IDLE )&& (GetGunState(GUN_B) == GUN_CONNECTED)) 
				{
...
extern INT32U  TTlasttime;
void HYKeyEvent84(_LCD_KEYVALUE *keyval)
{
	ST_Menu * ppage;
	switch(*keyval)
    {
		case LCD_KEY1:				//点击确定返回主界面
			TTlasttime = OSTimeGet();  //赋值一下当前的最新时间
			DisplayCommonMenu(&HYMenu73,NULL);
			break;
		default:
		    break;
...
void HYKeyEvent85(_LCD_KEYVALUE *keyval)
{
   _FLASH_OPERATION  FlashOper;
	ST_Menu * ppage;
	switch(*keyval)
