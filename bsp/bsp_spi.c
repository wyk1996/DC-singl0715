...
void bsp_InitSPI1(void)
{
	...
	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOB, ENABLE);     //time
	
	/* ??GPIO ?? */
	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOC | RCC_AHB1Periph_GPIOA, ENABLE);     //PC10   PC11  PC12
	...
	/* ?? SCK, MISO ? MOSI ????? */
	GPIO_PinAFConfig(GPIOC, GPIO_PinSource10, GPIO_AF_SPI3);   //===zhengque:GPIO_AF_SPI3    //cuowu=GPIO_AF5_SPI3
...
//	RCC_APB2PeriphClockCmd(RCC_APB2Periph_SPI5, ENABLE);
	...
	RCC_APB1PeriphClockCmd(RCC_APB1Periph_SPI3, ENABLE);   //zhengque
...
INT8U SPI1_SendRcvByte( INT8U Data, INT8U *statu)
{
	...
	*statu = FALSE;
	...
	while (SPI_I2S_GetFlagStatus(SPI3, SPI_I2S_FLAG_TXE) == RESET)
	{
		...
		{
			//??????,????
//			RCC_APB2PeriphResetCmd(RCC_APB1Periph_SPI2, ENABLE);        //??SPI1??
//            DelayUs(5);
//            RCC_APB2PeriphResetCmd(RCC_APB1Periph_SPI2, DISABLE);       //????SPI1??
//            DelayUs(5);
